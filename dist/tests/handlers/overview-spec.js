...
describe('overview handler', function () {
    describe('401 status code', function () {
        it('no jwt to /current_order should produce 401 response', function () { return __awaiter(void 0, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/current_order')];
                    case 1:
                        resp = _a.sent();
        ...
        it('no jwt to /completed_orders should produce 401 response', function () { return __awaiter(void 0, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/completed_orders')];
                    case 1:
                        resp = _a.sent();
                        expect(resp.status).toBe(401);
                        return [2 /*return*/];
    ...
    describe('200 status code', function () {
        ...
        it('get to /five_most_popular_products should return products', function () { return __awaiter(void 0, void 0, void 0, function () {
            var resp, arr;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request.get('/five_most_popular_products')];
                    case 1:
                        resp = _a.sent();
                        arr = resp.body;
        ...
        it('get to /current_order should return products', function () { return __awaiter(void 0, void 0, void 0, function () {
            var resp, order;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        expect(order.status).toBe(order_1.OrderStatus.open);
                        return [2 /*return*/];
                }
            });
        }); });
        it('get to /completed_orders should return products', function () { return __awaiter(void 0, void 0, void 0, function () {
            var resp, arr;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, request
                    ...
                    case 1:
                        ...
                        expect(arr[0].status).toBe(order_1.OrderStatus.completed);
                        return [2 /*return*/];
                }
            });
        }); });
