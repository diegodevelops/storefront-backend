            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        conn.release();
                        arr_1 = [];
                        result.rows.map(function (r) { return arr_1.push(_this.getUserFrom(r)); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, this.getUserFrom(result.rows[0])];
                    case 3:
                        err_2 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable delete user (".concat(id, "): ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("unable to create user (".concat(u.firstName, "): ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
