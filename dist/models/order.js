...
var OrderStore = /** @class */ (function () {
    ...
    OrderStore.prototype.getOrderFrom = function (dbOrder) {
        return {
            id: dbOrder.id,
    ...
    OrderStore.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, arr_1, err_1;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        conn.release();
                        arr_1 = [];
                        result.rows.map(function (r) { return arr_1.push(_this.getOrderFrom(r)); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, this.getOrderFrom(result.rows[0])];
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not create order from user ".concat(o.userId, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderStore.prototype.show = function (userId, status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        sql = (status) ? "".concat(sql, " AND status=($2)") : sql;
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not create order from user ".concat(userId, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [o.status, o.userId, o.id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                        return [2 /*return*/, this.getOrderFrom(result.rows[0])];
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not create order from user ".concat(o.userId, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("unable delete order (".concat(id, "): ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        result = _a.sent();
                        order = this.getOrderFrom(result.rows[0]);
                        conn.release();
